...
def encode(str)
  ...
  # map to codewords
  out.each_slice(2).map {|a,b| a * 30 + b }
end
...
def to_png(ary, opts = {})
  to_chunky_png(ary, opts).to_datastream.to_s
end
...
row.times do |r|
  ...
  # left side
  out = @lbar + ('%17b' % @look[cid][case cid
  ...
  # data portion
  col.times do |c|
    out << ('%17b' % @look[cid][cws[pos]])
    pos += 1
  end

  # right side
  out += ('%17b' % @look[cid][case cid
